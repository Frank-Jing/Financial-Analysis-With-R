...
chartSeries(YHOO, subset = 'last 4 months') # subset : xts style date subsetting argument
...
# plot the log return of each stock
library(quantmod)
...
mean(mmm)
var(mmm)
sd(mmm) # standard deviation
t.test(mmm)  # Testing H0: mean return = 0
...
abline(m1$coef) # Add the linear regression line



# compute the mean and corvariance of 2 stocks and simulate their distributions
